...
class RpcTestBase : public KuduTest {
 ...
 protected:
  ...
  Status StartTestServer(Sockaddr *server_addr,
                         bool enable_ssl = false) {
    return DoStartTestServer<GenericCalculatorService>(server_addr, enable_ssl);
  }
  ...
  Status StartTestServerWithCustomMessenger(Sockaddr *server_addr,
    ...
    return DoStartTestServer<GenericCalculatorService>(server_addr, enable_ssl, messenger);
  }
 ...
 private:
  ...
  Status DoStartTestServer(Sockaddr *server_addr, bool enable_ssl = false,
